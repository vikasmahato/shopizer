		...
		<div class="span12 common-row">
			  ...
			  <div class="span8 col-md-8 no-padding">
				<div class="checkout-box">
				    ...
				    <div class="panel panel-default">
                      <div class="panel-heading">
                        <s:message code="label.customer.billingaddress" text="Billing Address" />
                        <button class="btn btn-primary btn-xs" onclick="editAddress('${customer.id}');"><s:message code="label.generic.edit" text="Edit"/></button>
                      </div>
				...
				<div class="checkout-box">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                          <s:message code="label.customer.shippingaddress" text="Shipping Address" />
                          <c:if test="${not empty customer.delivery}">
                            <button class="btn btn-primary button-xs" onclick="editShippingAddress('${customer.id}');"><s:message code="label.generic.edit" text="Edit"/></button>
                        </c:if>
                      </div>
                      <div class="panel-body">
					...
					<c:if test="${empty customer.delivery}">
							...
							<input type="hidden" name="customerId" value="${customer.id}">
							<input type="hidden" name="billingAddress" value="false"/>
							<a class="btn btn-primary" href="javascript:void(0)" onclick="addShippingAddress('${customer.id}');"><s:message code="menu.addaddress" text="Add a New Address" /></a> <br />
							</form:form>
				    </c:if>
