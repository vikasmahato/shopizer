              ...
              <div class="btn-group" style="z-index:400000;">
                    <button class="btn btn-info dropdown-toggle" data-toggle="dropdown"><s:message code="label.product.configure" text="Product definition"/> ... <span class="caret"></span></button>
                     <ul class="dropdown-menu">
				    	...
				    	<li><a href="<c:url value="/admin/product/displayProductToSpecifications.html" />?id=<c:out value="${productId}"/>"><s:message code="label.product.attribute.specifications" text="Specifications" /></a></li>
				    	...
				    	<!-- commented <li><a href="<c:url value="/admin/products/reviews.html" />?id=<c:out value="${productId}"/>"><s:message code="label.product.customer.reviews" text="Reviews" /></a></li> -->
